...
namespace f30.Application.WebApi.PlayGames
{
    /// <summary>
    /// Manages the application layer for the PlayGamesWebApi.
    /// </summary>
    public class PlayGamesWebApiLogicManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayGamesWebApiLogicManager"/> class.
        /// </summary>
        public PlayGamesWebApiLogicManager() { }
        ...
        public void Insert(DataJSONWrapper dataWrapper)
        {
            ...
            _dataManager.PlayGameDataAdministrator.Initialise();

            // Create a new data item
            PlayGame item = (PlayGame)_dataManager.PlayGameDataAdministrator.Items.AddItem();
            ...
            _dataManager.PlayGameDataAdministrator.Save();
                                            ...
                                            DataJSONWrapper dataWrapper)
        {
            ...
            // Load the data
            _dataManager.PlayGameDataAdministrator.LoadItemsByRelativeMemberID(relativeMemberID);
        ...
        private DataJSONWrapper DataToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            DataJSONWrapper w = _dataManager.PlayGameDataAdministrator.ToWrapper();
            w.ID = "PlayGames";

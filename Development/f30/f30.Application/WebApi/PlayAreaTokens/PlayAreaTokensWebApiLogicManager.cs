...
namespace f30.Application.WebApi.PlayAreaTokens
{
    /// <summary>
    /// Manages the application layer for the PlayAreaTokensWebApi.
    /// </summary>
    public class PlayAreaTokensWebApiLogicManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayAreaTokensWebApiLogicManager"/> class.
        /// </summary>
        public PlayAreaTokensWebApiLogicManager() { }
        ...
        public void Insert(DataJSONWrapper dataWrapper)
        {
            ...
            _dataManager.PlayAreaTokenDataAdministrator.Initialise();

            // Create a new data item
            PlayAreaToken item = (PlayAreaToken)_dataManager.PlayAreaTokenDataAdministrator.Items.AddItem();
            ...
            _dataManager.PlayAreaTokenDataAdministrator.Save();
                                            ...
                                            DataJSONWrapper dataWrapper)
        {
            ...
            // Load the data
            _dataManager.PlayAreaTokenDataAdministrator.LoadItemsByRelativeMemberID(relativeMemberID);
        ...
        private DataJSONWrapper DataToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            DataJSONWrapper w = _dataManager.PlayAreaTokenDataAdministrator.ToWrapper();
            w.ID = "PlayAreaTokens";

...
namespace f30.Application.WebApi.PlayAreaTiles
{
    /// <summary>
    /// Manages the application layer for the PlayAreaTilesWebApi.
    /// </summary>
    public class PlayAreaTilesWebApiLogicManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayAreaTilesWebApiLogicManager"/> class.
        /// </summary>
        public PlayAreaTilesWebApiLogicManager() { }
        ...
        public void Insert(DataJSONWrapper dataWrapper)
        {
            ...
            _dataManager.PlayAreaTileDataAdministrator.Initialise();

            // Create a new data item
            PlayAreaTile item = (PlayAreaTile)_dataManager.PlayAreaTileDataAdministrator.Items.AddItem();
            ...
            _dataManager.PlayAreaTileDataAdministrator.Save();
                                            ...
                                            DataJSONWrapper dataWrapper)
        {
            ...
            // Load the data
            _dataManager.PlayAreaTileDataAdministrator.LoadItemsByRelativeMemberID(relativeMemberID);
        ...
        private DataJSONWrapper DataToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            DataJSONWrapper w = _dataManager.PlayAreaTileDataAdministrator.ToWrapper();
            w.ID = "PlayAreaTiles";

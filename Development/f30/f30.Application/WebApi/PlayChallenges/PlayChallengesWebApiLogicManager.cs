...
namespace f30.Application.WebApi.PlayChallenges
{
    /// <summary>
    /// Manages the application layer for the PlayChallengesWebApi.
    /// </summary>
    public class PlayChallengesWebApiLogicManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayChallengesWebApiLogicManager"/> class.
        /// </summary>
        public PlayChallengesWebApiLogicManager() { }
        ...
        public void Insert(DataJSONWrapper dataWrapper)
        {
            ...
            _dataManager.PlayChallengeDataAdministrator.Initialise();

            // Create a new data item
            PlayChallenge item = (PlayChallenge)_dataManager.PlayChallengeDataAdministrator.Items.AddItem();
            ...
            _dataManager.PlayChallengeDataAdministrator.Save();
                                            ...
                                            DataJSONWrapper dataWrapper)
        {
            ...
            // Load the data
            _dataManager.PlayChallengeDataAdministrator.LoadItemsByRelativeMemberID(relativeMemberID);
        ...
        private DataJSONWrapper DataToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            DataJSONWrapper w = _dataManager.PlayChallengeDataAdministrator.ToWrapper();
            w.ID = "PlayChallenges";

...
namespace f30.Application.WebApi.PlayAreaTileTypes
{
    /// <summary>
    /// Manages the application layer for the PlayAreaTileTypesWebApi.
    /// </summary>
    public class PlayAreaTileTypesWebApiLogicManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayAreaTileTypesWebApiLogicManager"/> class.
        /// </summary>
        public PlayAreaTileTypesWebApiLogicManager() { }
        ...
        public void Insert(DataJSONWrapper dataWrapper)
        {
            ...
            _dataManager.PlayAreaTileTypeDataAdministrator.Initialise();

            // Create a new data item
            PlayAreaTileType item = (PlayAreaTileType)_dataManager.PlayAreaTileTypeDataAdministrator.Items.AddItem();
            ...
            _dataManager.PlayAreaTileTypeDataAdministrator.Save();
                                            ...
                                            DataJSONWrapper dataWrapper)
        {
            ...
            // Load the data
            _dataManager.PlayAreaTileTypeDataAdministrator.LoadItemsByRelativeMemberID(relativeMemberID);
        ...
        private DataJSONWrapper DataToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            DataJSONWrapper w = _dataManager.PlayAreaTileTypeDataAdministrator.ToWrapper();
            w.ID = "PlayAreaTileTypes";

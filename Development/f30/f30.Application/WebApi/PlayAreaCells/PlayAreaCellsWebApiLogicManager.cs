...
namespace f30.Application.WebApi.PlayAreaCells
{
    /// <summary>
    /// Manages the application layer for the PlayAreaCellsWebApi.
    /// </summary>
    public class PlayAreaCellsWebApiLogicManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayAreaCellsWebApiLogicManager"/> class.
        /// </summary>
        public PlayAreaCellsWebApiLogicManager() { }
        ...
        public void Insert(DataJSONWrapper dataWrapper)
        {
            ...
            _dataManager.PlayAreaCellDataAdministrator.Initialise();

            // Create a new data item
            PlayAreaCell item = (PlayAreaCell)_dataManager.PlayAreaCellDataAdministrator.Items.AddItem();
            ...
            _dataManager.PlayAreaCellDataAdministrator.Save();
                                            ...
                                            DataJSONWrapper dataWrapper)
        {
            ...
            // Load the data
            _dataManager.PlayAreaCellDataAdministrator.LoadItemsByRelativeMemberID(relativeMemberID);
        ...
        private DataJSONWrapper DataToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            DataJSONWrapper w = _dataManager.PlayAreaCellDataAdministrator.ToWrapper();
            w.ID = "PlayAreaCells";

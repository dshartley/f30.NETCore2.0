...
namespace f30.Application.WebApi.PlayAreaCellTypes
{
    /// <summary>
    /// Manages the application layer for the PlayAreaCellTypesWebApi.
    /// </summary>
    public class PlayAreaCellTypesWebApiLogicManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayAreaCellTypesWebApiLogicManager"/> class.
        /// </summary>
        public PlayAreaCellTypesWebApiLogicManager() { }
        ...
        public void Insert(DataJSONWrapper dataWrapper)
        {
            ...
            _dataManager.PlayAreaCellTypeDataAdministrator.Initialise();

            // Create a new data item
            PlayAreaCellType item = (PlayAreaCellType)_dataManager.PlayAreaCellTypeDataAdministrator.Items.AddItem();
            ...
            _dataManager.PlayAreaCellTypeDataAdministrator.Save();
                                            ...
                                            DataJSONWrapper dataWrapper)
        {
            ...
            // Load the data
            _dataManager.PlayAreaCellTypeDataAdministrator.LoadItemsByRelativeMemberID(relativeMemberID);
        ...
        private DataJSONWrapper DataToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            DataJSONWrapper w = _dataManager.PlayAreaCellTypeDataAdministrator.ToWrapper();
            w.ID = "PlayAreaCellTypes";

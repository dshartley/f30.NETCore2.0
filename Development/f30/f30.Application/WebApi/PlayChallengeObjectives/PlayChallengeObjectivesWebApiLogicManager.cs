...
namespace f30.Application.WebApi.PlayChallengeObjectives
{
    /// <summary>
    /// Manages the application layer for the PlayChallengeObjectivesWebApi.
    /// </summary>
    public class PlayChallengeObjectivesWebApiLogicManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayChallengeObjectivesWebApiLogicManager"/> class.
        /// </summary>
        public PlayChallengeObjectivesWebApiLogicManager() { }
        ...
        public void Insert(DataJSONWrapper dataWrapper)
        {
            ...
            _dataManager.PlayChallengeObjectiveDataAdministrator.Initialise();

            // Create a new data item
            PlayChallengeObjective item = (PlayChallengeObjective)_dataManager.PlayChallengeObjectiveDataAdministrator.Items.AddItem();
            ...
            _dataManager.PlayChallengeObjectiveDataAdministrator.Save();
                                            ...
                                            DataJSONWrapper dataWrapper)
        {
            ...
            // Load the data
            _dataManager.PlayChallengeObjectiveDataAdministrator.LoadItemsByRelativeMemberID(relativeMemberID);
        ...
        private DataJSONWrapper DataToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            DataJSONWrapper w = _dataManager.PlayChallengeObjectiveDataAdministrator.ToWrapper();
            w.ID = "PlayChallengeObjectives";

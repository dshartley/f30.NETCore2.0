...
namespace f30.Application.WebApi.PlayExperienceStepExercises
{
    /// <summary>
    /// Manages the application layer for the PlayExperienceStepExercisesWebApi.
    /// </summary>
    public class PlayExperienceStepExercisesWebApiLogicManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayExperienceStepExercisesWebApiLogicManager"/> class.
        /// </summary>
        public PlayExperienceStepExercisesWebApiLogicManager() { }
        ...
        public void Insert(DataJSONWrapper dataWrapper)
        {
            ...
            _dataManager.PlayExperienceStepExerciseDataAdministrator.Initialise();

            // Create a new data item
            PlayExperienceStepExercise item = (PlayExperienceStepExercise)_dataManager.PlayExperienceStepExerciseDataAdministrator.Items.AddItem();
            ...
            _dataManager.PlayExperienceStepExerciseDataAdministrator.Save();
                                            ...
                                            DataJSONWrapper dataWrapper)
        {
            ...
            // Load the data
            _dataManager.PlayExperienceStepExerciseDataAdministrator.LoadItemsByRelativeMemberID(relativeMemberID);
        ...
        private DataJSONWrapper DataToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            DataJSONWrapper w = _dataManager.PlayExperienceStepExerciseDataAdministrator.ToWrapper();
            w.ID = "PlayExperienceStepExercises";

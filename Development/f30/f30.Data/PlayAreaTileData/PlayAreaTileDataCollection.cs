...
namespace f30.Data.PlayAreaTileData
{
    ...
    /// </summary>
    public class PlayAreaTileDataCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayAreaTileDataCollection() : base() { }

        public PlayAreaTileDataCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayAreaTileDataCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayAreaTileData item = new PlayAreaTileData(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayAreaTileData item = new PlayAreaTileData(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayAreaTileData item = (PlayAreaTileData)this.GetNewItem();

...
namespace f30.Data.PlaySubsets
{
    ...
    /// </summary>
    public class PlaySubsetCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlaySubsetCollection() : base() { }

        public PlaySubsetCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlaySubsetCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlaySubset item = new PlaySubset(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlaySubset item = new PlaySubset(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlaySubset item = (PlaySubset)this.GetNewItem();

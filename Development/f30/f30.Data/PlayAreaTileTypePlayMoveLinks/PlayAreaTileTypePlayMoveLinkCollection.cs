...
{
    /// <summary>
    /// Encapsulates a collection of PlayAreaTileTypePlayMoveLink items.
    /// </summary>
    public class PlayAreaTileTypePlayMoveLinkCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayAreaTileTypePlayMoveLinkCollection() : base() { }

        public PlayAreaTileTypePlayMoveLinkCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayAreaTileTypePlayMoveLinkCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayAreaTileTypePlayMoveLink item = new PlayAreaTileTypePlayMoveLink(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayAreaTileTypePlayMoveLink item = new PlayAreaTileTypePlayMoveLink(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayAreaTileTypePlayMoveLink item = (PlayAreaTileTypePlayMoveLink)this.GetNewItem();

...
{
    /// <summary>
    /// Manages PlayAreaTileTypePlayMoveLink data.
    /// </summary>
    public class PlayAreaTileTypePlayMoveLinkDataAdministrator : DataAdministratorBase
    {
        #region Constructors

        private PlayAreaTileTypePlayMoveLinkDataAdministrator() : base() { }

        public PlayAreaTileTypePlayMoveLinkDataAdministrator( IDataManagementPolicy       dataManagementPolicy,
        ...
        {
            return new PlayAreaTileTypePlayMoveLinkCollection(this, _defaultCultureInfoName);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<PlayAreaTileTypePlayMoveLinkWrapper> ToWrappers()
        {
            List<PlayAreaTileTypePlayMoveLinkWrapper> result = new List<PlayAreaTileTypePlayMoveLinkWrapper>();
            ...
            foreach (IDataItem item in this._items.Items)
            {
                ...
                {
                    // Get item wrapper
                    PlayAreaTileTypePlayMoveLinkWrapper wrapper = ((PlayAreaTileTypePlayMoveLink)item).ToWrapper();
        ...
        public void LoadItemsByPlayAreaTileTypeID(int playAreaTileTypeID)
        {
            ...
            // Load the data
            _items = ((IPlayAreaTileTypePlayMoveLinkDataAccessStrategy)_dataAccessStrategy).SelectByPlayAreaTileTypeID(_items, playAreaTileTypeID);
        ...
        public void LoadItemsByPlaySubsetID(int playSubsetID)
        {
            ...
            // Load the data
            _items = ((IPlayAreaTileTypePlayMoveLinkDataAccessStrategy)_dataAccessStrategy).SelectByPlaySubsetID(_items,
                                                                                                    playSubsetID);
            this.DoAfterLoad();
        }

...
{
    /// <summary>
    /// Encapsulates a collection of PlayExperienceStepResult items.
    /// </summary>
    public class PlayExperienceStepResultCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayExperienceStepResultCollection() : base() { }

        public PlayExperienceStepResultCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayExperienceStepResultCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayExperienceStepResult item = new PlayExperienceStepResult(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayExperienceStepResult item = new PlayExperienceStepResult(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayExperienceStepResult item = (PlayExperienceStepResult)this.GetNewItem();

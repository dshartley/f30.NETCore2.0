...
{
    /// <summary>
    /// A wrapper for a PlayExperienceStep item.
    /// </summary>
    public class PlayExperienceStepWrapper : DataItemWrapperBase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="PlayExperienceStepWrapper"/> class.
        /// </summary>
        public PlayExperienceStepWrapper() : base()
        {
        }
        ...
        private PlayExperienceStepTypes _playExperienceStepType;

        public PlayExperienceStepTypes PlayExperienceStepType
        {
            get { return _playExperienceStepType; }
            set { _playExperienceStepType = value; }
        }

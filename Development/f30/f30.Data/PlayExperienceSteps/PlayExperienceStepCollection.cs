...
namespace f30.Data.PlayExperienceSteps
{
    ...
    /// </summary>
    public class PlayExperienceStepCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayExperienceStepCollection() : base() { }

        public PlayExperienceStepCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayExperienceStepCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayExperienceStep item = new PlayExperienceStep(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayExperienceStep item = new PlayExperienceStep(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayExperienceStep item = (PlayExperienceStep)this.GetNewItem();

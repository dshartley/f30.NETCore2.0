...
namespace f30.Data.PlayAreaPaths
{
    ...
    /// </summary>
    public class PlayAreaPathCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayAreaPathCollection() : base() { }

        public PlayAreaPathCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayAreaPathCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayAreaPath item = new PlayAreaPath(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayAreaPath item = new PlayAreaPath(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayAreaPath item = (PlayAreaPath)this.GetNewItem();

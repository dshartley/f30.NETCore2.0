...
namespace f30.Data.PlayAreaPaths
{
    ...
    /// </summary>
    public class PlayAreaPathDataAdministrator : DataAdministratorBase
    {
        #region Constructors

        private PlayAreaPathDataAdministrator() : base() { }

        public PlayAreaPathDataAdministrator( IDataManagementPolicy       dataManagementPolicy,
        ...
        {
            return new PlayAreaPathCollection(this, _defaultCultureInfoName);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<PlayAreaPathWrapper> ToWrappers()
        {
            List<PlayAreaPathWrapper> result = new List<PlayAreaPathWrapper>();
            ...
            foreach (IDataItem item in this._items.Items)
            {
                ...
                {
                    // Get item wrapper
                    PlayAreaPathWrapper wrapper = ((PlayAreaPath)item).ToWrapper();

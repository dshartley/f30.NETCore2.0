...
namespace f30.Data.PlayAreaCells
{
    ...
    /// </summary>
    public class PlayAreaCellCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayAreaCellCollection() : base() { }

        public PlayAreaCellCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayAreaCellCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayAreaCell item = new PlayAreaCell(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayAreaCell item = new PlayAreaCell(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayAreaCell item = (PlayAreaCell)this.GetNewItem();

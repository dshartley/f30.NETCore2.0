...
namespace f30.Data.PlayExperiencePlayExperienceStepLinks
{
    ...
    /// </summary>
    public class PlayExperiencePlayExperienceStepLinkDataAdministrator : DataAdministratorBase
    {
        #region Constructors

        private PlayExperiencePlayExperienceStepLinkDataAdministrator() : base() { }

        public PlayExperiencePlayExperienceStepLinkDataAdministrator( IDataManagementPolicy       dataManagementPolicy,
        ...
        {
            return new PlayExperiencePlayExperienceStepLinkCollection(this, _defaultCultureInfoName);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<PlayExperiencePlayExperienceStepLinkWrapper> ToWrappers()
        {
            List<PlayExperiencePlayExperienceStepLinkWrapper> result = new List<PlayExperiencePlayExperienceStepLinkWrapper>();
            ...
            foreach (IDataItem item in this._items.Items)
            {
                ...
                {
                    // Get item wrapper
                    PlayExperiencePlayExperienceStepLinkWrapper wrapper = ((PlayExperiencePlayExperienceStepLink)item).ToWrapper();
        ...
        /// <summary>
        /// Loads the items by PlayExperienceID.
        /// </summary>
        /// <param name="playExperienceID">The PlayExperienceID.</param>
        public void LoadItemsByPlayExperienceID(int playExperienceID)
        {
            #region Check Parameters
            ...
            // Load the data
            _items = ((IPlayExperiencePlayExperienceStepLinkDataAccessStrategy)_dataAccessStrategy).SelectByPlayExperienceID(_items, playExperienceID);
        ...
        public void LoadItemsByPlaySubsetID(int playSubsetID)
        {
            ...
            // Load the data
            _items = ((IPlayExperiencePlayExperienceStepLinkDataAccessStrategy)_dataAccessStrategy).SelectByPlaySubsetID(_items,
                                                                                                    playSubsetID);
            this.DoAfterLoad();
        }

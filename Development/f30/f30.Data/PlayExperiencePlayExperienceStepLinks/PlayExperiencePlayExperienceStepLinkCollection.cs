...
namespace f30.Data.PlayExperiencePlayExperienceStepLinks
{
    ...
    /// </summary>
    public class PlayExperiencePlayExperienceStepLinkCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayExperiencePlayExperienceStepLinkCollection() : base() { }

        public PlayExperiencePlayExperienceStepLinkCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayExperiencePlayExperienceStepLinkCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayExperiencePlayExperienceStepLink item = new PlayExperiencePlayExperienceStepLink(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayExperiencePlayExperienceStepLink item = new PlayExperiencePlayExperienceStepLink(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayExperiencePlayExperienceStepLink item = (PlayExperiencePlayExperienceStepLink)this.GetNewItem();

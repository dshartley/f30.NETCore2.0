...
{
    /// <summary>
    /// Manages PlayChallengeTypePlayMoveLink data.
    /// </summary>
    public class PlayChallengeTypePlayMoveLinkDataAdministrator : DataAdministratorBase
    {
        #region Constructors

        private PlayChallengeTypePlayMoveLinkDataAdministrator() : base() { }

        public PlayChallengeTypePlayMoveLinkDataAdministrator( IDataManagementPolicy       dataManagementPolicy,
        ...
        {
            return new PlayChallengeTypePlayMoveLinkCollection(this, _defaultCultureInfoName);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<PlayChallengeTypePlayMoveLinkWrapper> ToWrappers()
        {
            List<PlayChallengeTypePlayMoveLinkWrapper> result = new List<PlayChallengeTypePlayMoveLinkWrapper>();
            ...
            foreach (IDataItem item in this._items.Items)
            {
                ...
                {
                    // Get item wrapper
                    PlayChallengeTypePlayMoveLinkWrapper wrapper = ((PlayChallengeTypePlayMoveLink)item).ToWrapper();
        ...
        public void LoadItemsByPlayChallengeTypeID(int playChallengeTypeID)
        {
            ...
            // Load the data
            _items = ((IPlayChallengeTypePlayMoveLinkDataAccessStrategy)_dataAccessStrategy).SelectByPlayChallengeTypeID(_items, playChallengeTypeID);
        ...
        public void LoadItemsByPlaySubsetID(int playSubsetID)
        {
            ...
            // Load the data
            _items = ((IPlayChallengeTypePlayMoveLinkDataAccessStrategy)_dataAccessStrategy).SelectByPlaySubsetID(_items,
                                                                                                    playSubsetID);
            this.DoAfterLoad();
        }

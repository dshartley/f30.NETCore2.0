...
{
    /// <summary>
    /// Encapsulates a collection of PlayChallengeTypePlayMoveLink items.
    /// </summary>
    public class PlayChallengeTypePlayMoveLinkCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayChallengeTypePlayMoveLinkCollection() : base() { }

        public PlayChallengeTypePlayMoveLinkCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayChallengeTypePlayMoveLinkCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayChallengeTypePlayMoveLink item = new PlayChallengeTypePlayMoveLink(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayChallengeTypePlayMoveLink item = new PlayChallengeTypePlayMoveLink(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayChallengeTypePlayMoveLink item = (PlayChallengeTypePlayMoveLink)this.GetNewItem();

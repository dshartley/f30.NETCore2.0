...
{
    /// <summary>
    /// Provides SQL Server data access for PlayAreaTileType data.
    /// </summary>
    public class PlayAreaTileTypeSQLServerDataAccessStrategy : SQLServerDataAccessStrategyBase, IPlayAreaTileTypeDataAccessStrategy
    {
        ...
        private PlayAreaTileTypeSQLServerDataAccessStrategy() : base() { }

        public PlayAreaTileTypeSQLServerDataAccessStrategy(string connectionString,
                                                    CultureInfo cultureInfo)
            : base(connectionString, cultureInfo, "PlayAreaTileTypes")
        { }

        #endregion

        #region IPlayAreaTileTypeDataAccessStrategy Methods
        ...
        IDataItemCollection IPlayAreaTileTypeDataAccessStrategy.SelectByPlaySubsetID(IDataItemCollection collection,
                                                                                    int playSubsetID)
        {
            ...
            DataSet                         data = this.RunProcedureLoad("sp_PlayAreaTileTypesSelectByPlaySubsetID", parameters);

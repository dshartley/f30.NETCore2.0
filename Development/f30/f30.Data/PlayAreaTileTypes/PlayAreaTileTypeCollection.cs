...
namespace f30.Data.PlayAreaTileTypes
{
    ...
    /// </summary>
    public class PlayAreaTileTypeCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayAreaTileTypeCollection() : base() { }

        public PlayAreaTileTypeCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayAreaTileTypeCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayAreaTileType item = new PlayAreaTileType(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayAreaTileType item = new PlayAreaTileType(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayAreaTileType item = (PlayAreaTileType)this.GetNewItem();

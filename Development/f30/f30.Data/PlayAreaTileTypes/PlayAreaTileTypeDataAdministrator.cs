...
namespace f30.Data.PlayAreaTileTypes
{
    ...
    /// </summary>
    public class PlayAreaTileTypeDataAdministrator : DataAdministratorBase
    {
        #region Constructors

        private PlayAreaTileTypeDataAdministrator() : base() { }

        public PlayAreaTileTypeDataAdministrator( IDataManagementPolicy       dataManagementPolicy,
        ...
        {
            return new PlayAreaTileTypeCollection(this, _defaultCultureInfoName);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<PlayAreaTileTypeWrapper> ToWrappers()
        {
            List<PlayAreaTileTypeWrapper> result = new List<PlayAreaTileTypeWrapper>();
            ...
            foreach (IDataItem item in this._items.Items)
            {
                ...
                {
                    // Get item wrapper
                    PlayAreaTileTypeWrapper wrapper = ((PlayAreaTileType)item).ToWrapper();
        ...
        public void LoadItemsByPlaySubsetID(int playSubsetID)
        {
            ...
            // Load the data
            _items = ((IPlayAreaTileTypeDataAccessStrategy)_dataAccessStrategy).SelectByPlaySubsetID(_items,
                                                                                                    playSubsetID);
            this.DoAfterLoad();
        }

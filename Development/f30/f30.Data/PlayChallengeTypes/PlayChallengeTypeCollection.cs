...
namespace f30.Data.PlayChallengeTypes
{
    ...
    /// </summary>
    public class PlayChallengeTypeCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayChallengeTypeCollection() : base() { }

        public PlayChallengeTypeCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayChallengeTypeCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayChallengeType item = new PlayChallengeType(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayChallengeType item = new PlayChallengeType(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayChallengeType item = (PlayChallengeType)this.GetNewItem();

...
namespace f30.Data.PlayChallengeTypes
{
    ...
    /// <summary>
    /// Encapsulates an PlayChallengeType data item.
    /// </summary>
    public class PlayChallengeType : DataItemBase
    {
        #region Constructors

        private PlayChallengeType() : base() { }

        public PlayChallengeType(  XmlDocument         dataDocument,
                        IDataItemCollection collection,
                        string              defaultCultureInfoName)
            : base(dataDocument, collection, defaultCultureInfoName)
        { }

        public PlayChallengeType(  XmlNode             dataNode,
                        IDataItemCollection collection,
                        string              defaultCultureInfoName)
        ...
        /// </summary>
        /// <returns></returns>
        public PlayChallengeTypeWrapper ToWrapper()
        {
            PlayChallengeTypeWrapper result = new PlayChallengeTypeWrapper();
        ...
        public void Copy(PlayChallengeTypeWrapper fromWrapper)
        {
        ...
        protected override void InitialisePropertyIndexes()
        {
            ...
            _startEnumIndex = (int)DataProperties.PlayChallengeTypes_ID;
            _endEnumIndex   = (int)DataProperties.PlayChallengeTypes_VersionOwnerID;
        }
        ...
        protected override void InitialisePropertyKeys()
        {
            ...
            _keys.Add(_idKey,                   (int)DataProperties.PlayChallengeTypes_ID);
            _keys.Add(_playsubsetidKey,         (int)DataProperties.PlayChallengeTypes_PlaySubsetID);
            _keys.Add(_nameKey,                 (int)DataProperties.PlayChallengeTypes_Name);
            _keys.Add(_contentdataKey,          (int)DataProperties.PlayChallengeTypes_ContentData);
            _keys.Add(_oncompletedataKey,       (int)DataProperties.PlayChallengeTypes_OnCompleteData);
            _keys.Add(_versionidKey,            (int)DataProperties.PlayChallengeTypes_VersionID);
            _keys.Add(_versiondateKey,          (int)DataProperties.PlayChallengeTypes_VersionDate);
            _keys.Add(_versionowneridKey,       (int)DataProperties.PlayChallengeTypes_VersionOwnerID);
        }
        ...
        public override void Copy(IDataItem copy)
        {
            ...
            this.ID                     = ((PlayChallengeType)copy).ID;
            this.PlaySubsetID           = ((PlayChallengeType)copy).PlaySubsetID;
            this.Name                   = ((PlayChallengeType)copy).Name;
            this.ContentData            = ((PlayChallengeType)copy).ContentData;
            this.OnCompleteData         = ((PlayChallengeType)copy).OnCompleteData;
            this.VersionID              = ((PlayChallengeType)copy).VersionID;
            this.VersionDate            = ((PlayChallengeType)copy).VersionDate;
            this.VersionOwnerID         = ((PlayChallengeType)copy).VersionOwnerID;
        ...
        public override DataJSONWrapper CopyToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            dataWrapper.SetParameterValue(PlayChallengeTypeDataParameterKeys.PlaySubsetID.ToString(), this.PlaySubsetID.ToString());
            dataWrapper.SetParameterValue(PlayChallengeTypeDataParameterKeys.Name.ToString(), this.Name.ToString());
            dataWrapper.SetParameterValue(PlayChallengeTypeDataParameterKeys.ContentData.ToString(), this.ContentData);
            dataWrapper.SetParameterValue(PlayChallengeTypeDataParameterKeys.OnCompleteData.ToString(), this.OnCompleteData);
            dataWrapper.SetParameterValue(PlayChallengeTypeDataParameterKeys.VersionID.ToString(), this.VersionID.ToString());
            dataWrapper.SetParameterValue(PlayChallengeTypeDataParameterKeys.VersionDate.ToString(), this.VersionDate.ToString("g", this._outputCultureInfo));
            dataWrapper.SetParameterValue(PlayChallengeTypeDataParameterKeys.VersionOwnerID.ToString(), this.VersionOwnerID.ToString());
        ...
        public override void CopyFromWrapper(DataJSONWrapper dataWrapper, CultureInfo fromCultureInfo)
        {
            ...
            this.PlaySubsetID           = Int32.Parse(dataWrapper.GetParameterValue(PlayChallengeTypeDataParameterKeys.PlaySubsetID.ToString()));
            this.Name                   = dataWrapper.GetParameterValue(PlayChallengeTypeDataParameterKeys.Name.ToString());
            this.ContentData            = dataWrapper.GetParameterValue(PlayChallengeTypeDataParameterKeys.ContentData.ToString());
            this.OnCompleteData         = dataWrapper.GetParameterValue(PlayChallengeTypeDataParameterKeys.OnCompleteData.ToString());
            this.VersionID              = Int32.Parse(dataWrapper.GetParameterValue(PlayChallengeTypeDataParameterKeys.VersionID.ToString()));
            this.VersionDate            = DateTime.Parse(dataWrapper.GetParameterValue(PlayChallengeTypeDataParameterKeys.VersionDate.ToString()));
            this.VersionOwnerID         = Int32.Parse(dataWrapper.GetParameterValue(PlayChallengeTypeDataParameterKeys.VersionOwnerID.ToString()));
        ...
        public override string GetProperty(int propertyEnum, CultureInfo toCultureInfo)
        {
            ...
            switch (propertyEnum)
            {
                case (int)DataProperties.PlayChallengeTypes_VersionDate:

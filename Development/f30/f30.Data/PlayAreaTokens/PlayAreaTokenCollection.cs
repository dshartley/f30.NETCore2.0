...
namespace f30.Data.PlayAreaTokens
{
    ...
    /// </summary>
    public class PlayAreaTokenCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayAreaTokenCollection() : base() { }

        public PlayAreaTokenCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayAreaTokenCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayAreaToken item = new PlayAreaToken(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayAreaToken item = new PlayAreaToken(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayAreaToken item = (PlayAreaToken)this.GetNewItem();

...
namespace f30.Data.PlayExperienceStepPlayExperienceStepExerciseLinks
{
    ...
    /// </summary>
    public class PlayExperienceStepPlayExperienceStepExerciseLinkCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayExperienceStepPlayExperienceStepExerciseLinkCollection() : base() { }

        public PlayExperienceStepPlayExperienceStepExerciseLinkCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayExperienceStepPlayExperienceStepExerciseLinkCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayExperienceStepPlayExperienceStepExerciseLink item = new PlayExperienceStepPlayExperienceStepExerciseLink(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayExperienceStepPlayExperienceStepExerciseLink item = new PlayExperienceStepPlayExperienceStepExerciseLink(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayExperienceStepPlayExperienceStepExerciseLink item = (PlayExperienceStepPlayExperienceStepExerciseLink)this.GetNewItem();

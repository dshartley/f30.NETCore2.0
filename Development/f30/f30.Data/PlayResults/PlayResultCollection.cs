...
namespace f30.Data.PlayResults
{
    ...
    /// </summary>
    public class PlayResultCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayResultCollection() : base() { }

        public PlayResultCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayResultCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayResult item = new PlayResult(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayResult item = new PlayResult(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayResult item = (PlayResult)this.GetNewItem();

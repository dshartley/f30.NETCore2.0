...
namespace f30.Data.PlayChallenges
{
    ...
    /// </summary>
    public class PlayChallengeCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayChallengeCollection() : base() { }

        public PlayChallengeCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayChallengeCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayChallenge item = new PlayChallenge(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayChallenge item = new PlayChallenge(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayChallenge item = (PlayChallenge)this.GetNewItem();

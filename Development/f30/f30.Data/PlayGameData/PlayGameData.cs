...
namespace f30.Data.PlayGameData
{
    ...
    /// <summary>
    /// Encapsulates an PlayGameData data item.
    /// </summary>
    public class PlayGameData : DataItemBase
    {
        #region Constructors

        private PlayGameData() : base() { }

        public PlayGameData(  XmlDocument         dataDocument,
                        IDataItemCollection collection,
                        string              defaultCultureInfoName)
            : base(dataDocument, collection, defaultCultureInfoName)
        { }

        public PlayGameData(  XmlNode             dataNode,
                        IDataItemCollection collection,
                        string              defaultCultureInfoName)
        ...
        protected const string _datelastplayedKey = "DateLastPlayed";

        /// <summary>
        /// Gets or sets the DateLastPlayed.
        /// </summary>
        /// <value>The DateLastPlayed.</value>
        [System.ComponentModel.Browsable(false)]
        public DateTime DateLastPlayed
        {
            get
            {
                return DateTime.Parse(_node.Attributes[_datelastplayedKey].Value);
            }
            set
            {
                this.SetProperty(_datelastplayedKey, value.ToString(), false);
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public PlayGameDataWrapper ToWrapper()
        {
            PlayGameDataWrapper result = new PlayGameDataWrapper();

            result.ID                   = this.ID;
            result.RelativeMemberID     = this.RelativeMemberID;
            result.PlayGameID           = this.PlayGameID;
            result.DateLastPlayed       = this.DateLastPlayed;
            result.OnCompleteData       = this.OnCompleteData;
            result.AttributeData        = this.AttributeData;

            result.DeserializeOnCompleteData();
        ...
        protected override void InitialiseDataNode()
        {
            ...
            this.SetAttribute(_datelastplayedKey, "1/1/1900");
        ...
        protected override void InitialisePropertyIndexes()
        {
            ...
            _startEnumIndex = (int)DataProperties.PlayGameData_ID;
            _endEnumIndex   = (int)DataProperties.PlayGameData_AttributeData;
        }
        ...
        protected override void InitialisePropertyKeys()
        {
            ...
            _keys.Add(_idKey,                   (int)DataProperties.PlayGameData_ID);
            _keys.Add(_relativememberidKey,     (int)DataProperties.PlayGameData_RelativeMemberID);
            _keys.Add(_playgameidKey,           (int)DataProperties.PlayGameData_PlayGameID);
            _keys.Add(_datelastplayedKey,       (int)DataProperties.PlayGameData_DateLastPlayed);
            _keys.Add(_oncompletedataKey,       (int)DataProperties.PlayGameData_OnCompleteData);
            _keys.Add(_attributedataKey,        (int)DataProperties.PlayGameData_AttributeData);            
        }
        ...
        public override void Copy(IDataItem copy)
        {
            ...
            this.ID                     = ((PlayGameData)copy).ID;
            this.RelativeMemberID       = ((PlayGameData)copy).RelativeMemberID;
            this.PlayGameID             = ((PlayGameData)copy).PlayGameID;
            this.DateLastPlayed         = ((PlayGameData)copy).DateLastPlayed;
            this.OnCompleteData         = ((PlayGameData)copy).OnCompleteData;
            this.AttributeData          = ((PlayGameData)copy).AttributeData;
        ...
        public override DataJSONWrapper CopyToWrapper(DataJSONWrapper dataWrapper)
        {
            ...
            dataWrapper.SetParameterValue(PlayGameDataDataParameterKeys.RelativeMemberID.ToString(), this.RelativeMemberID.ToString());
            dataWrapper.SetParameterValue(PlayGameDataDataParameterKeys.PlayGameID.ToString(), this.PlayGameID.ToString());
            dataWrapper.SetParameterValue(PlayGameDataDataParameterKeys.DateLastPlayed.ToString(), this.DateLastPlayed.ToString("g", this._outputCultureInfo));
            dataWrapper.SetParameterValue(PlayGameDataDataParameterKeys.OnCompleteData.ToString(), this.OnCompleteData);
            dataWrapper.SetParameterValue(PlayGameDataDataParameterKeys.AttributeData.ToString(), this.AttributeData);        
        ...
        public override void CopyFromWrapper(DataJSONWrapper dataWrapper, CultureInfo fromCultureInfo)
        {
            ...
            this.RelativeMemberID       = Int32.Parse(dataWrapper.GetParameterValue(PlayGameDataDataParameterKeys.RelativeMemberID.ToString()));
            this.PlayGameID             = Int32.Parse(dataWrapper.GetParameterValue(PlayGameDataDataParameterKeys.PlayGameID.ToString()));
            this.DateLastPlayed         = DateTime.Parse(dataWrapper.GetParameterValue(PlayGameDataDataParameterKeys.DateLastPlayed.ToString()));
            this.OnCompleteData         = dataWrapper.GetParameterValue(PlayGameDataDataParameterKeys.OnCompleteData.ToString());
            this.AttributeData          = dataWrapper.GetParameterValue(PlayGameDataDataParameterKeys.AttributeData.ToString());
        ...
        public override string GetProperty(int propertyEnum, CultureInfo toCultureInfo)
        {
            ...
            switch (propertyEnum)
            {
                case (int)DataProperties.PlayGameData_DateLastPlayed:
                    s = this.DateLastPlayed.ToString("g", toCultureInfo); // MM/dd/yyyy HH:mm
                    break;
                default:

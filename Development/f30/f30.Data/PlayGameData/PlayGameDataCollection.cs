...
namespace f30.Data.PlayGameData
{
    ...
    /// </summary>
    public class PlayGameDataCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayGameDataCollection() : base() { }

        public PlayGameDataCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayGameDataCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayGameData item = new PlayGameData(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayGameData item = new PlayGameData(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayGameData item = (PlayGameData)this.GetNewItem();

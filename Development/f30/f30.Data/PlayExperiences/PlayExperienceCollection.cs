...
namespace f30.Data.PlayExperiences
{
    ...
    /// </summary>
    public class PlayExperienceCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayExperienceCollection() : base() { }

        public PlayExperienceCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayExperienceCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayExperience item = new PlayExperience(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayExperience item = new PlayExperience(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayExperience item = (PlayExperience)this.GetNewItem();

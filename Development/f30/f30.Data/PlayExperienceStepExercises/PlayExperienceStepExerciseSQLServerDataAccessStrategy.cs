...
{
    /// <summary>
    /// Provides SQL Server data access for PlayExperienceStepExercise data.
    /// </summary>
    public class PlayExperienceStepExerciseSQLServerDataAccessStrategy : SQLServerDataAccessStrategyBase, IPlayExperienceStepExerciseDataAccessStrategy
    {
        ...
        private PlayExperienceStepExerciseSQLServerDataAccessStrategy() : base() { }

        public PlayExperienceStepExerciseSQLServerDataAccessStrategy(string connectionString,
                                                    CultureInfo cultureInfo)
            : base(connectionString, cultureInfo, "PlayExperienceStepExercises")
        { }

        #endregion

        #region IPlayExperienceStepExerciseDataAccessStrategy Methods
        ...
        IDataItemCollection IPlayExperienceStepExerciseDataAccessStrategy.SelectByPlaySubsetID(IDataItemCollection collection,
                                                                                    int playSubsetID)
        {
            ...
            DataSet                         data = this.RunProcedureLoad("sp_PlayExperienceStepExercisesSelectByPlaySubsetID", parameters);

...
namespace f30.Data.PlayExperienceStepExercises
{
    ...
    /// </summary>
    public class PlayExperienceStepExerciseDataAdministrator : DataAdministratorBase
    {
        #region Constructors

        private PlayExperienceStepExerciseDataAdministrator() : base() { }

        public PlayExperienceStepExerciseDataAdministrator( IDataManagementPolicy       dataManagementPolicy,
        ...
        {
            return new PlayExperienceStepExerciseCollection(this, _defaultCultureInfoName);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<PlayExperienceStepExerciseWrapper> ToWrappers()
        {
            List<PlayExperienceStepExerciseWrapper> result = new List<PlayExperienceStepExerciseWrapper>();
            ...
            foreach (IDataItem item in this._items.Items)
            {
                ...
                {
                    // Get item wrapper
                    PlayExperienceStepExerciseWrapper wrapper = ((PlayExperienceStepExercise)item).ToWrapper();
        ...
        public void LoadItemsByPlaySubsetID(int playSubsetID)
        {
            ...
            // Load the data
            _items = ((IPlayExperienceStepExerciseDataAccessStrategy)_dataAccessStrategy).SelectByPlaySubsetID(_items,
                                                                                                    playSubsetID);
            this.DoAfterLoad();
        }

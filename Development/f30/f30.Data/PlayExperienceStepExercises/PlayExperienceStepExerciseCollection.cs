...
namespace f30.Data.PlayExperienceStepExercises
{
    ...
    /// </summary>
    public class PlayExperienceStepExerciseCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayExperienceStepExerciseCollection() : base() { }

        public PlayExperienceStepExerciseCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayExperienceStepExerciseCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayExperienceStepExercise item = new PlayExperienceStepExercise(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayExperienceStepExercise item = new PlayExperienceStepExercise(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayExperienceStepExercise item = (PlayExperienceStepExercise)this.GetNewItem();

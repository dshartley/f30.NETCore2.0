...
{
    /// <summary>
    /// Provides SQL Server data access for PlayChallengeTypePlayChallengeObjectiveTypeLink data.
    /// </summary>
    public class PlayChallengeTypePlayChallengeObjectiveTypeLinkSQLServerDataAccessStrategy : SQLServerDataAccessStrategyBase, IPlayChallengeTypePlayChallengeObjectiveTypeLinkDataAccessStrategy
    {
        ...
        private PlayChallengeTypePlayChallengeObjectiveTypeLinkSQLServerDataAccessStrategy() : base() { }

        public PlayChallengeTypePlayChallengeObjectiveTypeLinkSQLServerDataAccessStrategy(string connectionString,
                                                    CultureInfo cultureInfo)
            : base(connectionString, cultureInfo, "PlayChallengeTypePlayChallengeObjectiveTypeLinks")
        { }

        #endregion

        #region IPlayChallengeTypePlayChallengeObjectiveTypeLinkDataAccessStrategy Methods
        ...
        IDataItemCollection IPlayChallengeTypePlayChallengeObjectiveTypeLinkDataAccessStrategy.SelectByPlayChallengeTypeID(   IDataItemCollection collection,
                                                                                                                int playChallengeTypeID)
        {
            ...
            DataSet data = this.RunProcedureLoad("sp_PlayChallengeTypePlayChallengeObjectiveTypeLinksSelectByPlayChallengeTypeID", parameters);
        ...
        IDataItemCollection IPlayChallengeTypePlayChallengeObjectiveTypeLinkDataAccessStrategy.SelectByPlaySubsetID(IDataItemCollection collection,
                                                                                    int playSubsetID)
        {
            #region Check Parameters
            ...
            // Call the stored procedure
            DataSet                         data = this.RunProcedureLoad("sp_PlayChallengeTypePlayChallengeObjectiveTypeLinksSelectByPlaySubsetID", parameters);

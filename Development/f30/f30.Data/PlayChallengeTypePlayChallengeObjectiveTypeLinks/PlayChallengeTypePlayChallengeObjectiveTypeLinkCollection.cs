...
{
    /// <summary>
    /// Encapsulates a collection of PlayChallengeTypePlayChallengeObjectiveTypeLink items.
    /// </summary>
    public class PlayChallengeTypePlayChallengeObjectiveTypeLinkCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayChallengeTypePlayChallengeObjectiveTypeLinkCollection() : base() { }

        public PlayChallengeTypePlayChallengeObjectiveTypeLinkCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayChallengeTypePlayChallengeObjectiveTypeLinkCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayChallengeTypePlayChallengeObjectiveTypeLink item = new PlayChallengeTypePlayChallengeObjectiveTypeLink(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayChallengeTypePlayChallengeObjectiveTypeLink item = new PlayChallengeTypePlayChallengeObjectiveTypeLink(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayChallengeTypePlayChallengeObjectiveTypeLink item = (PlayChallengeTypePlayChallengeObjectiveTypeLink)this.GetNewItem();

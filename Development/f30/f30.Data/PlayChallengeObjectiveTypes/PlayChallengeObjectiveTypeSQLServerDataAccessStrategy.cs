...
{
    /// <summary>
    /// Provides SQL Server data access for PlayChallengeObjectiveType data.
    /// </summary>
    public class PlayChallengeObjectiveTypeSQLServerDataAccessStrategy : SQLServerDataAccessStrategyBase, IPlayChallengeObjectiveTypeTypeDataAccessStrategy
    {
        ...
        private PlayChallengeObjectiveTypeSQLServerDataAccessStrategy() : base() { }

        public PlayChallengeObjectiveTypeSQLServerDataAccessStrategy(string connectionString,
                                                    CultureInfo cultureInfo)
            : base(connectionString, cultureInfo, "PlayChallengeObjectiveTypes")
        { }

        #endregion

        #region IPlayChallengeObjectiveTypeDataAccessStrategy Methods
        ...
        IDataItemCollection IPlayChallengeObjectiveTypeTypeDataAccessStrategy.SelectByRelativeMemberID(   IDataItemCollection collection,
                                                                                    int relativeMemberID)
        {
            ...
            DataSet data = this.RunProcedureLoad("sp_PlayChallengeObjectiveTypesSelectByRelativeMemberID", parameters);
        ...
        /// <exception cref="ApplicationException"></exception>
        /// <exception cref="System.ApplicationException"></exception>
        IDataItemCollection IPlayChallengeObjectiveTypeTypeDataAccessStrategy.SelectByPlaySubsetID(IDataItemCollection collection,
                                                                                    int playSubsetID)
        {
            #region Check Parameters
            ...
            // Call the stored procedure
            DataSet data = this.RunProcedureLoad("sp_PlayChallengeObjectiveTypesSelectByPlaySubsetID", parameters);

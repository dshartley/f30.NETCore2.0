...
{
    /// <summary>
    /// Manages PlayAreaCellTypePlayMoveLink data.
    /// </summary>
    public class PlayAreaCellTypePlayMoveLinkDataAdministrator : DataAdministratorBase
    {
        #region Constructors

        private PlayAreaCellTypePlayMoveLinkDataAdministrator() : base() { }

        public PlayAreaCellTypePlayMoveLinkDataAdministrator( IDataManagementPolicy       dataManagementPolicy,
        ...
        {
            return new PlayAreaCellTypePlayMoveLinkCollection(this, _defaultCultureInfoName);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<PlayAreaCellTypePlayMoveLinkWrapper> ToWrappers()
        {
            List<PlayAreaCellTypePlayMoveLinkWrapper> result = new List<PlayAreaCellTypePlayMoveLinkWrapper>();
            ...
            foreach (IDataItem item in this._items.Items)
            {
                ...
                {
                    // Get item wrapper
                    PlayAreaCellTypePlayMoveLinkWrapper wrapper = ((PlayAreaCellTypePlayMoveLink)item).ToWrapper();
        ...
        public void LoadItemsByPlayAreaCellTypeID(int playAreaCellTypeID)
        {
            ...
            // Load the data
            _items = ((IPlayAreaCellTypePlayMoveLinkDataAccessStrategy)_dataAccessStrategy).SelectByPlayAreaCellTypeID(_items, playAreaCellTypeID);
        ...
        public void LoadItemsByPlaySubsetID(int playSubsetID)
        {
            ...
            // Load the data
            _items = ((IPlayAreaCellTypePlayMoveLinkDataAccessStrategy)_dataAccessStrategy).SelectByPlaySubsetID(_items,
                                                                                                    playSubsetID);
            this.DoAfterLoad();
        }

...
namespace f30.Data.PlayAreaPathPoints
{
    ...
    /// </summary>
    public class PlayAreaPathPointDataAdministrator : DataAdministratorBase
    {
        #region Constructors

        private PlayAreaPathPointDataAdministrator() : base() { }

        public PlayAreaPathPointDataAdministrator( IDataManagementPolicy       dataManagementPolicy,
        ...
        {
            return new PlayAreaPathPointCollection(this, _defaultCultureInfoName);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<PlayAreaPathPointWrapper> ToWrappers()
        {
            List<PlayAreaPathPointWrapper> result = new List<PlayAreaPathPointWrapper>();
            ...
            foreach (IDataItem item in this._items.Items)
            {
                ...
                {
                    // Get item wrapper
                    PlayAreaPathPointWrapper wrapper = ((PlayAreaPathPoint)item).ToWrapper();

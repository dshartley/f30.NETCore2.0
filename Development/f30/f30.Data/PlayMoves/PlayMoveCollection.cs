...
namespace f30.Data.PlayMoves
{
    ...
    /// </summary>
    public class PlayMoveCollection : DataItemCollectionBase
    {
        #region Constructors

        private PlayMoveCollection() : base() { }

        public PlayMoveCollection(IDataAdministrator  dataAdministrator,
                                string              defaultCultureInfoName)
            : base(dataAdministrator, defaultCultureInfoName)
        { }

        public PlayMoveCollection(XmlDocument         dataDocument,
        ...
        {
            // Create the new item
            PlayMove item = new PlayMove(_dataDocument, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(XmlNode node)
        {
            ...
            // Create the item
            PlayMove item = new PlayMove(node, this, _defaultCultureInfoName);
        ...
        public override IDataItem GetNewItem(DataRow row, CultureInfo fromCultureInfo)
        {
            ...
            // Create the new item
            PlayMove item = (PlayMove)this.GetNewItem();

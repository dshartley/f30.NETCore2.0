...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PlayMoves]') AND type in (N'U'))
DROP TABLE [dbo].[PlayMoves]
GO
...
CREATE TABLE [dbo].[PlayMoves](
 ...
 CONSTRAINT [PK_PlayMoves] PRIMARY KEY CLUSTERED 
(
	[ID] ASC

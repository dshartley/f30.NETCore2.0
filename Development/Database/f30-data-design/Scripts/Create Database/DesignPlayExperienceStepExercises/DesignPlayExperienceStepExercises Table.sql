...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DesignPlayExperienceStepExercises]') AND type in (N'U'))
DROP TABLE [dbo].[DesignPlayExperienceStepExercises]
GO
...
CREATE TABLE [dbo].[DesignPlayExperienceStepExercises](
 ...
 CONSTRAINT [PK_DesignPlayExperienceStepExercises] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
